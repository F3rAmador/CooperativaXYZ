...
Public Class FrmNacionalidad
    ...
    Private Sub MostrarTodo()
        ...
        Using Cmd As New SqlCommand
            ...
            Try
                ...
                LsvNacionalidad.Items.Clear()

                While VerCargo.Read = True
                    With LsvNacionalidad.Items.Add(VerCargo("IdNacionalidad").ToString)
        ...
        Try
            ...
            Using Cmd As New SqlCommand
                With Cmd
                    ...
                    Id = CInt(LsvNacionalidad.FocusedItem.SubItems(0).Text)
    ...
    Private Sub ToolStripMenuItemEditar_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItemEditar.Click
        ...
        TxtNacionalidad.ReadOnly = False
        TxtIdNacionalidad.Text = LsvNacionalidad.FocusedItem.SubItems(0).Text
        TxtNacionalidad.Text = LsvNacionalidad.FocusedItem.SubItems(1).Text
    End Sub
